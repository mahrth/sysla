...
- [src/sysla.langium](src/sysla.langium) -  The grammar definition of your language
- [src/sysla-module.ts](src/sysla-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/sysla-validator.ts](src/sysla-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/sysla.monarch.ts](src/syntaxes/sysla.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/sysla.tmLanguage.json](syntaxes/sysla.tmLanguage.json) - Textmate based syntax highlighting instructions.
